...
class MarketEnv(Env):
    ...
    def get_data(self, symbol):
        ...
        try:
            f = open(fn, "r")
            for line in f:
                if line.strip() != "" and line.strip() != ',date,open,close,high,low,volume,code':
                    #dt, openPrice, high, low, close, volume = line.strip().split(",")
                    idx, dt, openPrice, close, high, low, volume, symbol = line.strip().split(",")
                    try:
    ...
    def step(self, action):
        ...
        #print("self.targetDates[self.currentTargetIndex]={}  self.currentTargetIndex={} len(self.targetDates)={}".format(self.targetDates[self.currentTargetIndex],self.currentTargetIndex,len(self.targetDates)))
