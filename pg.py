...
class PolicyGradient:
    def __init__(self, env, discount=0.99, model_filename=None, history_filename=None):
        ...
        self.model = MarketPolicyGradientModelBuilder(join(BASE_DIR, "models", model_filename + ".h5")).getModel()
    ...
    def train(self, max_episode=100, max_path_length=200, verbose=0):
        env = self.env
        model = self.model
        avg_reward_sum = 0.
